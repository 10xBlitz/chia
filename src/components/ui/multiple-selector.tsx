              ...
              return (
                <Badge
                  ...
                  className={cn(
                    ...
                    "data-[fixed]:bg-muted-foreground data-[fixed]:text-muted data-[fixed]:hover:bg-muted-foreground bg-blue-500",
                    badgeClassName
                  )}
                ...
                >
                  ...
                  >
                    <X className="h-3 w-3 text-whitehover:text-foreground" />
                  </button>
                </Badge>
              );
            })}
